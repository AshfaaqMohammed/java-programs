package com.Networking.websockets.server;
...
public class SimpleWebSocketServer extends WebSocketServer {
    ...
    public void onClose(WebSocket webSocket, int i, String s, boolean b) {
        ...
        String name = map.get(webSocket.getRemoteSocketAddress().toString());
        broadcastAllButSender(webSocket,"%s left the chat".formatted(name));
    }

    @Override
    public void onMessage(WebSocket webSocket, String s) {
        String name = map.get(webSocket.getRemoteSocketAddress().toString());
        broadcastAllButSender(webSocket,"%s : %s".formatted(name,s));
    }
    ...
    public void onError(WebSocket webSocket, Exception e) {
        System.out.println("Error thrown " + webSocket.getRemoteSocketAddress());
    }

...
public class Students {
    ...
    public Students(String countryCode, int yearEnrolled, int ageEnrolled, String gender, boolean programmingExperience, Course... courses) {
    ...
    public static Students getRandomStudent(Course... courses){
        ...
        for (Course c : courses){
            ...
            int year = random.nextInt(students.getYearEnrolled(),maxYear);
            ...
            students.watchLecture(c.courseCode(),lecture,month,year);
        }
